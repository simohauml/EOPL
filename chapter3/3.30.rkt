...
;; if no call to proc-val, expval->proc would report error
;; every value including procedure should be represented with a unified inside datatype
;; in other word, it must be "expressed value"